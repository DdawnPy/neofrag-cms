...
class m_news_c_admin_checker extends Controller_Module
{
	...
	{
		if (!$this->is_autorized('edit_news'))
		{
			throw new Exception(NeoFrag::UNAUTHORIZED);
		}
	...
	{
		if (!$this->is_autorized('delete_news'))
		{
			throw new Exception(NeoFrag::UNAUTHORIZED);
		}
	...
	{
		if (!$this->is_autorized('add_news_categories'))
		{
			throw new Exception(NeoFrag::UNAUTHORIZED);
		}
	}
	...
	{
		if (!$this->is_autorized('edit_news_categories'))
		{
			throw new Exception(NeoFrag::UNAUTHORIZED);
		}
